...
hand, the degree of improvement is much reduced when performing method
...
includes the time taken by elements of the tool-chain besides just our
own compiler, so the timings seen here are able to be compared. We
suspect that the primary reason for the out-performance of the x86
...
rest of the LLVM tool-chain in terms of compilation time.
