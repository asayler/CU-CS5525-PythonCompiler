...
improvement is much reduced when perfoming method calls and attribute
...
elements of the toolchain besides just our own compiler, so the
timings seen here are able to be compared. We suspect that the primary
reason for the outperformance of the x86 compiler by the LLVM compiler
...
toolchain in terms of compilation time.
