...
with Python's polymorphism, because this was helpful and probably necessary
for dealing with the typing of LLVM.
...
build environment. We believe it provides a strong argument for
building compilers that build to the LLVM IR, and then using the LLVM tools
to compile
